...
export default function Home() {
    ...
    return (
        <div>
            ...
            <section id="amenities" className="section-divider bg-light">
                <div className="container">
                    <div className="text-center mb-5">
                        <h2 className="display-5">Our Amenities</h2>
                        <p className="lead text-muted">Enjoy our wide range of facilities during your stay</p>
                    </div>
                    
                    <div className="row g-4">
                        <div className="col-md-6 col-lg-4">
                            <div className="d-flex align-items-center">
                                <div className="amenity-icon me-3">
                                    <i className="bi bi-wifi"></i>
                                </div>
                                <div>
                                    <h4>Free WiFi</h4>
                                    <p className="text-muted mb-0">High-speed internet throughout the property</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-md-6 col-lg-4">
                            <div className="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted mb-0">Fresh local ingredients daily</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-md-6 col-lg-4">
                            <div className="d-flex align-items-center">
                                ...
                                <div>
                                    <h4>Free Parking</h4>
                                    <p className="text-muted mb-0">Secure on-site parking for guests</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-md-6 col-lg-4">
                            <div className="d-flex align-items-center">
                                ...
                                <div>
                                    <h4>Garden Access</h4>
                                    <p className="text-muted mb-0">Beautiful gardens to relax in</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-md-6 col-lg-4">
                            <div className="d-flex align-items-center">
                                ...
                                <div>
                                    <h4>Coffee & Tea</h4>
                                    <p className="text-muted mb-0">Complimentary in all rooms</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-md-6 col-lg-4">
                            <div className="d-flex align-items-center">
                                ...
                                <div>
                                    <h4>Lounge Area</h4>
                                    <p className="text-muted mb-0">Comfortable shared spaces</p>
                                </div>
                            </div>
                        </div>
                    </div>
